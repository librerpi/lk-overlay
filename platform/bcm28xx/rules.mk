...
# clk-bcm2835.c says PLLB has a min of 600mhz
ARM_FREQ_MHZ := 1000
...
MODULE_DEFINES += PLLA_FREQ_MHZ=$(PLLA_FREQ_MHZ) PLLA_CORE_DIV=$(PLLA_CORE_DIV) PLLA_PER_DIV=$(PLLA_PER_DIV) PLLC_FREQ_MHZ=$(PLLC_FREQ_MHZ) PLLC_PER_DIV=$(PLLC_PER_DIV) PLLC_CORE0_DIV=$(PLLC_CORE0_DIV)
