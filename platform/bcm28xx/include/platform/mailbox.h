...
typedef struct {
  ...
  uint32_t r4;
  uint32_t r5;
} mbox_property_execute_code_request;

typedef struct {
  uint32_t r0;
} mbox_property_execute_code_reply;
...
typedef struct {
  ...
  uint32_t reply_size;
  union {
    mbox_property_execute_code_request req;
    mbox_property_execute_code_reply reply;
  };
} mbox_property_execute_code;

typedef struct {
  uint32_t temp_id;
} mbox_property_temp_request;

typedef struct {
  uint32_t temp_id;
  uint32_t temperature;
} mbox_property_temp_reply;
...
typedef struct {
  ...
  uint32_t reply_size;
  union {
    mbox_property_temp_request req;
    mbox_property_temp_reply reply;
  };
} mbox_property_get_temp;
